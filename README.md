...
A token is used to track your authentification per session

- [ ] What steps can you take in your web apps to keep your data secure?

Implement a login and private route so that only authorized users can view your site

- [ ] Describe how web servers work.

They store information and return or update it based on our request
